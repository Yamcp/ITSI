...
if (!function_exists('formatear_periodo_academico_mes_anio')) {
     ...
     *
     * @param array<string, mixed>|null $periodo Fila de TAB_PERIODOS_ACADEMICOS
     */
...
if (!function_exists('obtener_periodo_academico_para_ui')) {
    ...
    function obtener_periodo_academico_para_ui(): array
    {
        try {
            ...
            // Sin vistas (hosting compartido): período más reciente por calendario
            $row = $db->table('TAB_PERIODOS_ACADEMICOS')
