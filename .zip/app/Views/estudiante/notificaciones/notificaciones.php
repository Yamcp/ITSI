        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <div class="filter-buttons">
                    <button class="btn btn-outline-primary active" data-filter="todas">
                        <i class="fas fa-list me-1"></i>Todas
                    </button>
                    <button class="btn btn-outline-warning" data-filter="no_leidas">
                        <i class="fas fa-exclamation-circle me-1"></i>No Leídas
                    </button>
                    <button class="btn btn-outline-info" data-filter="asignacion_practica">
                        <i class="fas fa-briefcase me-1"></i>Prácticas
                    </button>
                    <button class="btn btn-outline-success" data-filter="recordatorio">
                                        ...
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="text-center">
                                                    <?php if ($notificacion['TIPO_NOTIFICACION'] == 'asignacion_practica'): ?>
                                                        <i class="fas fa-briefcase fa-2x text-primary"></i>
                                                    <?php elseif ($notificacion['TIPO_NOTIFICACION'] == 'tutoria_asignada'): ?>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <small class="text-muted">
                                                    ...
                                                    <?php if ($notificacion['LEIDA'] && $notificacion['FECHA_LEIDA']): ?>
                                                        | <i class="fas fa-check me-1"></i>Leída: <?= date('d/m/Y H:i', strtotime($notificacion['FECHA_LEIDA'])) ?>
                                                    <?php endif; ?>
                                                </small>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="notification-actions text-end">
                                                    <?php if (!$notificacion['LEIDA']): ?>
                                                        <button class="btn btn-sm btn-outline-primary" onclick="marcarLeida(<?= $notificacion['ID_NOTIFICACION'] ?>)">
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (elemento) {
                        ...
                        const btnMarcar = elemento.querySelector('.notification-actions .btn-outline-primary');
                        if (btnMarcar) {
                            btnMarcar.remove();
                        }
