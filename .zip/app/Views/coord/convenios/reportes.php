        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?= base_url('coord/convenios') ?>" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-12">
                <div class="filtros-container">
                    ...
                    <form method="GET" action="<?= base_url('coord/convenios/reportes') ?>">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 d-flex align-items-end">
                                ...
                                <a href="<?= base_url('coord/convenios/reportes') ?>" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="export-buttons">
                            <a href="<?= base_url('coord/convenios/generarReporte') . '?formato=pdf&' . http_build_query($filtros) ?>"
                                class="btn btn-outline-danger">
                                <i class="fas fa-file-pdf me-1"></i>Exportar PDF
                            </a>
                            <a href="<?= base_url('coord/convenios/generarReporte') . '?formato=excel&' . http_build_query($filtros) ?>"
