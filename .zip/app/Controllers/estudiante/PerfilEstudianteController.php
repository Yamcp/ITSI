...
class PerfilEstudianteController extends BaseController
{
    ...
    public function update()
    {
        ...
        // Log para depuración
        log_message('info', 'PerfilEstudianteController::update - Iniciando actualización de perfil');
        ...
        if ($resultado) {
            return redirect()->to(base_url('estudiante/perfil'))->with('success', 'Perfil actualizado correctamente');
        } else {
