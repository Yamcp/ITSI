...
class DocumentosCoordController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('coord/documentos/documentos_views');
    }

    public function documentosPracticas()
    {
        // Cargar la vista de documentos de prácticas
        return view('coord/documentos/documentos_practicas');
    }

    /**
     * URL del menú lateral: coord/documentos/servicio/* .
    ...
    public function documentosServicioComunitario()
    {
        ...
        return redirect()->to('coord/documentos/servicio' . $suffix);
    }
