...
<script>
    ...
    function generarPDF() {
        ...
        const url = `<?= base_url('coord/reportes-evaluaciones/pdf') ?>?${new URLSearchParams(filtros).toString()}`;
    ...
    function exportarExcel() {
        const filtros = obtenerFiltrosActuales();
        const url = `<?= base_url('coord/reportes-evaluaciones/excel') ?>?${new URLSearchParams(filtros).toString()}`;
        window.open(url, '_blank');
    ...
    function exportarCSV() {
        const filtros = obtenerFiltrosActuales();
        const url = `<?= base_url('coord/reportes-evaluaciones/csv') ?>?${new URLSearchParams(filtros).toString()}`;
        window.open(url, '_blank');
    ...
    function cargarDatosGraficos() {
        const filtros = obtenerFiltrosActuales();
        const url = `<?= base_url('coord/reportes-evaluaciones/graficos') ?>?${new URLSearchParams(filtros).toString()}`;
    ...
    function cargarEstadisticasReportes() {
        const filtros = obtenerFiltrosActuales();
        const url = `<?= base_url('coord/evaluaciones/estadisticas') ?>?${new URLSearchParams(filtros).toString()}`;
    ...
    function actualizarVistaPrevia() {
        const filtros = obtenerFiltrosActuales();
        const url = `<?= base_url('coord/evaluaciones/filtros') ?>`;
