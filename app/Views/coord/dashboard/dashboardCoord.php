    ...
    <div class="container-fluid px-3 px-md-4 pb-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3 col-sm-6">
                <a href="<?= base_url('coord/estudiantes') ?>" style="text-decoration: none;">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="<?= base_url('coord/instructores') ?>" style="text-decoration: none;">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="<?= base_url('coord/educacion') ?>" style="text-decoration: none;">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="<?= base_url('coord/convenios') ?>" style="text-decoration: none;">
...
<script>
    ...
    function crearGraficos() {
        ...
        function navegarA(seccion) {
            const rutas = {
                'practicas': '/coord/practicas',
                'convenios': '/coord/convenios',
                'educacion': '/coord/educacion',
                'instructores': '/coord/instructores',
                'documentos-practicas': '/coord/documentos/practicas',
                'reportes': '/coord/reportes-evaluaciones'
            };
