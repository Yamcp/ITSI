            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?= base_url('docente/actividades-educacion/ver/' . $actividad['ID_ACTIVIDAD_EDUCACION']) ?>" class="btn btn-info">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('docente/actividades-educacion/actualizar/' . $actividad['ID_ACTIVIDAD_EDUCACION']) ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="descripcion" rows="3" required><?= esc(old('descripcion', $actividad['DESCRIPCION'])) ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Objetivos<span class="text-danger">*</span></label>
                                <textarea class="form-control" name="objetivos" rows="3" required><?= esc(old('objetivos', $actividad['OBJETIVOS'])) ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Programa Detallado</label>
                                <textarea class="form-control" name="programa_detallado" rows="4"><?= esc(old('programa_detallado', $actividad['PROGRAMA_DETALLADO'] ?? '')) ?></textarea>
                            </div>

                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="incluye_certificado" value="1" id="incluye_certificado" <?= !empty($actividad['INCLUYE_CERTIFICADO']) ? 'checked' : '' ?>>
                                <label class="form-check-label" for="incluye_certificado">Incluye certificado de participación</label>
                            </div>

                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?= base_url('docente/actividades-educacion/ver/' . $actividad['ID_ACTIVIDAD_EDUCACION']) ?>" class="btn btn-secondary">
