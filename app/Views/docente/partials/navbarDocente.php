...
if (!$periodoNombre) {
    try {
        ...
        log_message('error', 'Navbar docente - error obteniendo período académico actual: ' . $e->getMessage());
    }
}
?>
                    ...
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        if (!$foto_perfil && session()->get('id_usuario')) {
                            try {
                                ...
                                log_message('error', 'Navbar docente - error obteniendo foto de perfil: ' . $e->getMessage());
                            }
                        }
