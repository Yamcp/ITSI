        ...
        <div class="row">
            <div class="col-12">
                <h3 class="text-center my-3">
                    ...
                    Formularios de Evaluación Disponibles
                </h3>
                <p class="text-center text-muted mb-4">
                    Accede a los formularios de evaluación que debes completar
                </p>
            </div>
        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted">
                                Como docente, puedes acceder a los formularios de evaluación relacionados con tus cursos y actividades.
                                Haz clic en "Completar Evaluación" para acceder al formulario correspondiente.
                            </p>
                        </div>
                    </div>
                </div>
...
<script>
                ...
                <div class="card evaluation-card ${eval.tipo.toLowerCase()} h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mb-3">
                            ...
                            <strong>${formatearFecha(eval.fecha_vencimiento)}</strong>
                        </div>
                        <div class="mt-auto">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Vista de evaluaciones para docentes cargada');
        cargarEvaluaciones();
        cargarEstadisticas();
    });
</script>
