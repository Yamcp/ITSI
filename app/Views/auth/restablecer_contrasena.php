...
<head>
    ...
    <title>Nueva contraseña | Departamento de Vinculación</title>
    ...
    <style>
        body { min-height: 100vh; background: linear-gradient(135deg, rgba(33, 150, 243, 0.8), rgba(187, 222, 251, 0.85)); display: flex; align-items: center; justify-content: center; overflow: hidden; }
        body::before { content: ''; position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: -1; background-image: url('<?= base_url('login/assets/img/fondo_login.jpg') ?>'); background-size: cover; background-position: center; filter: blur(8px); transform: scale(1.1); }
        .login-card { border: none; border-radius: 1rem; box-shadow: 0 0.5rem 1rem 0 rgba(0, 0, 0, 0.1); animation: fadeInDown 0.7s; max-width: 400px; margin: 2rem auto; }
        ...
        @media (max-width: 576px) { .login-card { max-width: 95vw; } .card-body { padding: 1rem; } }
    </style>
</head>
        ...
        <div class="login-card card w-100">
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    <div class="login-subtitle">Ingresa tu nueva contraseña (mínimo 8 caracteres)</div>
                </div>
            ...
            <footer class="text-center mt-3 text-muted small">&copy; <?= date('Y') ?> Departamento de Vinculación</footer>
        </div>
    </div>
