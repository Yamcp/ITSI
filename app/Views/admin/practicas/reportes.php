        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?= base_url('admin/practicas') ?>" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-12">
                <div class="filtros-container">
                    ...
                    <form method="GET" action="<?= base_url('admin/practicas/reportes') ?>">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 d-flex align-items-end">
                                ...
                                <a href="<?= base_url('admin/practicas/reportes') ?>" class="btn btn-outline-secondary">
