...
<body>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <h4><?= count(array_filter($instructores, function($i) { return $i['TIPO_INSTRUCTOR'] === 'Interno'; })) ?></h4>
            <p>Instructores Internos</p>
        </div>
        <div class="stat-card">
            <h4><?= count(array_filter($instructores, function($i) { return $i['TIPO_INSTRUCTOR'] === 'Externo'; })) ?></h4>
