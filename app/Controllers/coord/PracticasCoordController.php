...
class PracticasCoordController extends BaseController
{
    ...
    public function index()
    {
        ...
        try {
            ...
            log_message('error', 'PracticasCoordController::index - Error carreras: ' . $e->getMessage());
        }
        ...
        return view('coord/practicas/practicas', $data);
    }
    ...
    private const ID_ESTADO_SERVICIO_EN_PROGRESO = 2;
    private const TEXTO_ESTADO_PREPROF_EN_PROGRESO = 'En Progreso';
    private const TEXTO_ESTADO_SERVICIO_EN_PROGRESO = 'En Progreso';
    ...
    public function crearPractica()
    {
        ...
        try {
            ...
            $asignacionData = [
                ...
                'ID_USUARIO' => 1, // Usuario coordinador por defecto
                'ID_ESTADO_PRACTICAS' => self::ID_ESTADO_ASIGNACION_EN_PROGRESO,
            ...
            if ($tipoPractica == 2) { // Prácticas Preprofesionales
                $practicaData = [
                    ...
                    'FECHA_INICIO' => $fechaInicio,
                    'FECHA_FIN' => $fechaFin,
                    'ID_ESTADO_PREPROFESIONAL' => self::ID_ESTADO_PREPROF_EN_PROGRESO,
                    'ESTADO_PRACTICA' => self::TEXTO_ESTADO_PREPROF_EN_PROGRESO,
                ];
                ...
                $servicioData = [
                    ...
                    'FECHA_INICIO' => $fechaInicio,
                    'FECHA_FIN' => $fechaFin,
                    'ID_ESTADO_SERVICIO' => self::ID_ESTADO_SERVICIO_EN_PROGRESO,
                    'ESTADO_SERVICIO' => self::TEXTO_ESTADO_SERVICIO_EN_PROGRESO,
                ];
    ...
    public function reportes()
    {
        ...
        return view('coord/practicas/reportes', $data);
    }
     ...
     */
    private function enviarNotificacionesPractica($idEstudiante, $idInstitucion, $tipoPractica, $asignacionId, $fechaInicio, $fechaFin, $horasTotal, $descripcion, int $idInstructor)
    {
        try {
            ...
            $tutor = $this->obtenerInformacionTutor($idInstructor);
            if (!$tutor) {
                log_message('error', 'No se pudo obtener información del instructor ID ' . $idInstructor . ' para notificación');
                return false;
            }
            ...
            $idUsuarioTutor = $this->obtenerIdUsuarioTutor($idInstructor);
            if (!$idUsuarioTutor) {
