...
class ActividadesEducacionEstudianteController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('estudiante/educacion/actividades_educacion_views', $data);
    }
    ...
    public function create()
    {
        ...
        return view('estudiante/educacion/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->actividadesModel->insert($datos)) {
            return redirect()->to('/estudiante/actividades-educacion')->with('success', 'Actividad creada exitosamente');
        }
    ...
    public function show($id)
    {
        ...
        return view('estudiante/educacion/show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('estudiante/educacion/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->actividadesModel->update($id, $datos)) {
            return redirect()->to('/estudiante/actividades-educacion')->with('success', 'Actividad actualizada exitosamente');
        }
    ...
    public function delete($id)
    {
        if ($this->actividadesModel->delete($id)) {
            return redirect()->to('/estudiante/actividades-educacion')->with('success', 'Actividad eliminada exitosamente');
        }
    ...
    public function exportarPDF()
    {
        ...
        $html = view('docente/educacion/reportes/pdf/reportes', $data);
