...
class EmpleadosInstructoresAdminController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/empleados-instructores/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin/empleados-instructores/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($resultado) {
            return redirect()->to('/admin/empleados-instructores')
    ...
    public function show($id)
    {
        ...
        return view('admin/empleados-instructores/show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/empleados-instructores/edit', $data);
    }
