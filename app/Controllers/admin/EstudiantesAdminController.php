...
class EstudiantesAdminController extends BaseController
{
    ...
    public function create()
    {
        ...
        return view('admin/estudiantes/create', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            return redirect()->to('/admin/estudiantes')->with('success', 'Estudiante creado exitosamente');
    ...
    public function show($id)
    {
        ...
        return view('admin/estudiantes/show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/estudiantes/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        try {
            ...
            return redirect()->to('/admin/estudiantes')->with('success', 'Estudiante actualizado exitosamente');
